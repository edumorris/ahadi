...
<div class="aux-row">
	<div class="aux-4-6 aux-tb-1 aux-mb-1">
		<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
			...
			<h2><?php _e( 'Shopping bag', 'woocommerce' ); ?></h2>
			...
			<div class="aux-row aux-cart-buttons">
				<div class="aux-3-5 aux-mb-1">			
					...
					<?php if ( wc_coupons_enabled() ) { ?>
						...
						<input type="text" name="coupon_code" class="aux-input-text aux-large aux-fill" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" />
						<input type="submit" class="button  aux-button aux-large aux-uppercase aux-dark-gray" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>" />
						</div>
				...
				<div class="aux-2-5 aux-mb-1">
					<input type="submit" class="button right aux-button aux-large aux-outline aux-tower-gray aux-uppercase" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>" />
				</div>
			</div>
