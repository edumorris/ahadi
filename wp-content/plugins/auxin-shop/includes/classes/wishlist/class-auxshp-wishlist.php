...
class AUXSHP_Wishlist {
    ...
    public function add() {
        ...
        if ( ! isset( $_POST['product_id'] ) || ! wp_verify_nonce( $_POST['verify_nonce'], 'remove_wishlist-' . $product_id ) ) wp_die();
        ...
        <table class="aux-shop-table" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th class="product-status"><?php _e( 'Stock Status', 'woocommerce' ); ?></th>
...
?>
                <tr>
                    ...
                    <td class="product-remove">
                        <a href="#" class="auxshp-wishlist auxshp-is-page available-remove remove" data-auxshp-verify_nonce="<?php echo wp_create_nonce( 'remove_wishlist-' . $id ); ?>" data-auxshp-product_id="<?php echo $id; ?>"><span class="aux-svg-symbol aux-medium-cross"></span></a>
                    </td>
